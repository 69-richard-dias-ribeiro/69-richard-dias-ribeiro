...
### - Some of the main **programming languages** I've written code in are:
...
### - Some of the main **web frameworks** I've used are:
...
### - By the way, I'm also very acquainted with **3D art** development using Blender 2.78 (+ texture creation using MS Paint + some GIMP plugins), as well as some computer graphics-related concepts, like shaders, materials, uv mapping, skeletal rigging, etc. You can see some of my best renderings <a href="https://richarddiasribeiro.cgsociety.org/" target="_blank">here</a>; 🎨
